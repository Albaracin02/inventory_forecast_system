...
<li class="nav-item">
  <a class="nav-link active" href="buttonforecast.php">
  ...
  <main id="main" class="main">
    ...
    <?php
$result = mysqli_query($conn, "SELECT COUNT(*) as total FROM fact_forecast");
$row = mysqli_fetch_assoc($result);
$totalRows = $row['total'];

if ($totalRows === '0') {
    // Display the HTML structure if there's no data
    echo '
    <div class="container">
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-body text-center">
                        <h5 class="card-title">No Forecasted Data for 2024</h5>
                        <!-- No Labels Form -->
                        <form class="row g-3" action="wew2.php" method="POST">
    ...
    echo '
    <h5 class="card-title" style="text-align: left;">Forecasting</h5>
